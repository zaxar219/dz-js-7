;(function () {
	...
	function main () {
		...
		buttonSave.addEventListener('click', buttonSaveClickHender)
	}

	function buttonSaveClickHender (event) {
	...
	function getOrderData () {
		const orderData = {
			...
			goot: document.querySelector('[data-new-order-good]').value || 'NotGood',
